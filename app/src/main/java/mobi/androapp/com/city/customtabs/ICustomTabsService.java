...
public interface ICustomTabsService extends IInterface {
    ...
    abstract class Stub extends Binder implements ICustomTabsService {
        private static final String DESCRIPTOR = "android.city.customtabs.ICustomTabsService";
        ...
        public Stub() {
            this.attachInterface(this, "android.city.customtabs.ICustomTabsService");
        }
        ...
        public static ICustomTabsService asInterface(IBinder obj) {
            if (obj == null) {
                ...
                IInterface iin = obj.queryLocalInterface("android.city.customtabs.ICustomTabsService");
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 2:
                    data.enforceInterface("android.city.customtabs.ICustomTabsService");
                ...
                case 6:
                    ...
                    return true;
                case 1598968902:
                    reply.writeString("android.city.customtabs.ICustomTabsService");
                    return true;
                default:
        ...
        private static class Proxy implements ICustomTabsService {
            ...
            public String getInterfaceDescriptor() {
                return "android.city.customtabs.ICustomTabsService";
            }
            ...
            public boolean warmup(long flags) throws RemoteException {
                ...
                boolean _result;
                try {
                    _data.writeInterfaceToken("android.city.customtabs.ICustomTabsService");
