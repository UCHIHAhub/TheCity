...
public final class GenreMovieRecyclerView extends RecyclerView {

    private static final String SAVED_SUPER_STATE = "super-state";
    private static final String SAVED_LAYOUT_MANAGER = "layout-manager-state";
    private Parcelable mLayoutManagerSavedState;

    public GenreMovieRecyclerView(Context context) {
        super(context);
    }

    public GenreMovieRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public GenreMovieRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
