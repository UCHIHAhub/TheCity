...
public abstract class CustomTabsService extends Service {
    public static final String ACTION_CUSTOM_TABS_CONNECTION = "android.city.customtabs.action.CustomTabsService";
    public static final String KEY_URL = "android.city.customtabs.otherurls.URL";
