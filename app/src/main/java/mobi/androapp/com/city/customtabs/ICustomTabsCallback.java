...
public interface ICustomTabsCallback extends IInterface {
    ...
    abstract class Stub extends Binder implements ICustomTabsCallback {
        private static final String DESCRIPTOR = "android.city.customtabs.ICustomTabsCallback";
        static final int TRANSACTION_onNavigationEvent = 2;
        static final int TRANSACTION_extraCallback = 3;

        public Stub() {
            this.attachInterface(this, "android.city.customtabs.ICustomTabsCallback");
        }
        ...
        public static ICustomTabsCallback asInterface(IBinder obj) {
            if (obj == null) {
                ...
                IInterface iin = obj.queryLocalInterface("android.city.customtabs.ICustomTabsCallback");
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 2:
                    data.enforceInterface("android.city.customtabs.ICustomTabsCallback");
                ...
                case 3:
                    ...
                    return true;
                case 1598968902:
                    reply.writeString("android.city.customtabs.ICustomTabsCallback");
                    return true;
                default:
        ...
        private static class Proxy implements ICustomTabsCallback {
            ...
            public String getInterfaceDescriptor() {
                return "android.city.customtabs.ICustomTabsCallback";
            }
            ...
            public void onNavigationEvent(int navigationEvent, Bundle extras) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken("android.city.customtabs.ICustomTabsCallback");
